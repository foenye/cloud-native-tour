...
import (
	...
	apisgreetingv1 "github.com/foenye/cloud-native-tour/crd-getting-started/pkg/apis/greeting/v1"
	...
	greetingv1 "github.com/foenye/cloud-native-tour/crd-getting-started/pkg/client/listers/greeting/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.GreetingV1().Foos(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GreetingV1().Foos(namespace).Watch(context.TODO(), options)
			},
		},
		&apisgreetingv1.Foo{},
		resyncPeriod,
...
func (f *fooInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisgreetingv1.Foo{}, f.defaultInformer)
}

func (f *fooInformer) Lister() greetingv1.FooLister {
	return greetingv1.NewFooLister(f.Informer().GetIndexer())
}
