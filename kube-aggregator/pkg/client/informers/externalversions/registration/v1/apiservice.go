...
import (
	...
	apisregistrationv1 "github.com/foenye/cloud-native-tour/kube-aggregator/pkg/apis/registration/v1"
	...
	registrationv1 "github.com/foenye/cloud-native-tour/kube-aggregator/pkg/client/listers/registration/v1"
...
type APIServiceInformer interface {
	...
	Lister() registrationv1.APIServiceLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.RegistrationV1().APIServices().List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.RegistrationV1().APIServices().Watch(context.TODO(), options)
			},
		},
		&apisregistrationv1.APIService{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *aPIServiceInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisregistrationv1.APIService{}, f.defaultInformer)
}

func (f *aPIServiceInformer) Lister() registrationv1.APIServiceLister {
	return registrationv1.NewAPIServiceLister(f.Informer().GetIndexer())
}
