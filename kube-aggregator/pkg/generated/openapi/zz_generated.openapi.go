...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		"github.com/foenye/cloud-native-tour/kube-aggregator/pkg/apis/registration/v1.APIService":               schema_pkg_apis_registration_v1_APIService(ref),
		"github.com/foenye/cloud-native-tour/kube-aggregator/pkg/apis/registration/v1.APIServiceCondition":      schema_pkg_apis_registration_v1_APIServiceCondition(ref),
		"github.com/foenye/cloud-native-tour/kube-aggregator/pkg/apis/registration/v1.APIServiceList":           schema_pkg_apis_registration_v1_APIServiceList(ref),
		"github.com/foenye/cloud-native-tour/kube-aggregator/pkg/apis/registration/v1.APIServiceSpec":           schema_pkg_apis_registration_v1_APIServiceSpec(ref),
		"github.com/foenye/cloud-native-tour/kube-aggregator/pkg/apis/registration/v1.APIServiceStatus":         schema_pkg_apis_registration_v1_APIServiceStatus(ref),
		"github.com/foenye/cloud-native-tour/kube-aggregator/pkg/apis/registration/v1.ServiceReference":         schema_pkg_apis_registration_v1_ServiceReference(ref),
		"github.com/foenye/cloud-native-tour/kube-aggregator/pkg/apis/registration/v1beta1.APIService":          schema_pkg_apis_registration_v1beta1_APIService(ref),
		"github.com/foenye/cloud-native-tour/kube-aggregator/pkg/apis/registration/v1beta1.APIServiceCondition": schema_pkg_apis_registration_v1beta1_APIServiceCondition(ref),
		"github.com/foenye/cloud-native-tour/kube-aggregator/pkg/apis/registration/v1beta1.APIServiceList":      schema_pkg_apis_registration_v1beta1_APIServiceList(ref),
		"github.com/foenye/cloud-native-tour/kube-aggregator/pkg/apis/registration/v1beta1.APIServiceSpec":      schema_pkg_apis_registration_v1beta1_APIServiceSpec(ref),
		"github.com/foenye/cloud-native-tour/kube-aggregator/pkg/apis/registration/v1beta1.APIServiceStatus":    schema_pkg_apis_registration_v1beta1_APIServiceStatus(ref),
		"github.com/foenye/cloud-native-tour/kube-aggregator/pkg/apis/registration/v1beta1.ServiceReference":    schema_pkg_apis_registration_v1beta1_ServiceReference(ref),
...
func schema_pkg_apis_registration_v1_APIService(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							...
							Default:     map[string]interface{}{},
							Ref:         ref("github.com/foenye/cloud-native-tour/kube-aggregator/pkg/apis/registration/v1.APIServiceSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							...
							Default:     map[string]interface{}{},
							Ref:         ref("github.com/foenye/cloud-native-tour/kube-aggregator/pkg/apis/registration/v1.APIServiceStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"github.com/foenye/cloud-native-tour/kube-aggregator/pkg/apis/registration/v1.APIServiceSpec", "github.com/foenye/cloud-native-tour/kube-aggregator/pkg/apis/registration/v1.APIServiceStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}

func schema_pkg_apis_registration_v1_APIServiceCondition(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
...
func schema_pkg_apis_registration_v1_APIServiceList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/foenye/cloud-native-tour/kube-aggregator/pkg/apis/registration/v1.APIService"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/foenye/cloud-native-tour/kube-aggregator/pkg/apis/registration/v1.APIService", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
	}
}

func schema_pkg_apis_registration_v1_APIServiceSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					"service": {
						SchemaProps: spec.SchemaProps{
							...
							Ref:         ref("github.com/foenye/cloud-native-tour/kube-aggregator/pkg/apis/registration/v1.ServiceReference"),
						},
					},
					"group": {
						SchemaProps: spec.SchemaProps{
		...
		Dependencies: []string{
			"github.com/foenye/cloud-native-tour/kube-aggregator/pkg/apis/registration/v1.ServiceReference"},
	}
}

func schema_pkg_apis_registration_v1_APIServiceStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/foenye/cloud-native-tour/kube-aggregator/pkg/apis/registration/v1.APIServiceCondition"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/foenye/cloud-native-tour/kube-aggregator/pkg/apis/registration/v1.APIServiceCondition"},
	}
}

func schema_pkg_apis_registration_v1_ServiceReference(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
...
func schema_pkg_apis_registration_v1beta1_APIService(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "APIService represents a server for a particular GroupVersion. Name must be \"version.group\".",
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Description: "Spec contains information for locating and communicating with a server",
							Default:     map[string]interface{}{},
							Ref:         ref("github.com/foenye/cloud-native-tour/kube-aggregator/pkg/apis/registration/v1beta1.APIServiceSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Description: "Status contains derived information about an API server",
							Default:     map[string]interface{}{},
							Ref:         ref("github.com/foenye/cloud-native-tour/kube-aggregator/pkg/apis/registration/v1beta1.APIServiceStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"github.com/foenye/cloud-native-tour/kube-aggregator/pkg/apis/registration/v1beta1.APIServiceSpec", "github.com/foenye/cloud-native-tour/kube-aggregator/pkg/apis/registration/v1beta1.APIServiceStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}

func schema_pkg_apis_registration_v1beta1_APIServiceCondition(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "APIServiceCondition describes the state of an APIService at a particular point",
...
func schema_pkg_apis_registration_v1beta1_APIServiceList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "APIServiceList is a list of APIService objects.",
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/foenye/cloud-native-tour/kube-aggregator/pkg/apis/registration/v1beta1.APIService"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/foenye/cloud-native-tour/kube-aggregator/pkg/apis/registration/v1beta1.APIService", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
	}
}

func schema_pkg_apis_registration_v1beta1_APIServiceSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "APIServiceSpec contains information for locating and communicating with a server. Only https is supported, though you are able to disable certificate verification.",
				...
				Properties: map[string]spec.Schema{
					"service": {
						SchemaProps: spec.SchemaProps{
							Description: "Service is a reference to the service for this API server.  It must communicate on port 443. If the Service is nil, that means the handling for the API groupversion is handled locally on this server. The call will simply delegate to the normal handler chain to be fulfilled.",
							Ref:         ref("github.com/foenye/cloud-native-tour/kube-aggregator/pkg/apis/registration/v1beta1.ServiceReference"),
						},
					},
					"group": {
						SchemaProps: spec.SchemaProps{
		...
		Dependencies: []string{
			"github.com/foenye/cloud-native-tour/kube-aggregator/pkg/apis/registration/v1beta1.ServiceReference"},
	}
}

func schema_pkg_apis_registration_v1beta1_APIServiceStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "APIServiceStatus contains derived information about an API server",
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/foenye/cloud-native-tour/kube-aggregator/pkg/apis/registration/v1beta1.APIServiceCondition"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/foenye/cloud-native-tour/kube-aggregator/pkg/apis/registration/v1beta1.APIServiceCondition"},
	}
}

func schema_pkg_apis_registration_v1beta1_ServiceReference(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "ServiceReference holds a reference to Service.legacy.k8s.io",
