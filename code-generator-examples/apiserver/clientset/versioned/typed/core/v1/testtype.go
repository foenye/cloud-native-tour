...
type TestTypeInterface interface {
	...
	Apply(ctx context.Context, testType *applyconfigurationcorev1.TestTypeApplyConfiguration, opts metav1.ApplyOptions) (result *corev1.TestType, err error)
	// Add a +genclient:noStatus comment above the type to avoid generating ApplyStatus().
	ApplyStatus(ctx context.Context, testType *applyconfigurationcorev1.TestTypeApplyConfiguration, opts metav1.ApplyOptions) (result *corev1.TestType, err error)
	TestTypeExpansion
}

// testTypes implements TestTypeInterface
type testTypes struct {
	*gentype.ClientWithListAndApply[*corev1.TestType, *corev1.TestTypeList, *applyconfigurationcorev1.TestTypeApplyConfiguration]
}

// newTestTypes returns a TestTypes
func newTestTypes(c *CoreV1Client, namespace string) *testTypes {
	return &testTypes{
		gentype.NewClientWithListAndApply[*corev1.TestType, *corev1.TestTypeList, *applyconfigurationcorev1.TestTypeApplyConfiguration](
			"testtypes",
			c.RESTClient(),
			...
			gentype.PrefersProtobuf[*corev1.TestType](),
		),
	}
}
