...
THIS_PKG="github.com/yeahfo/cloud-native-tour/api-aggregation-lib-multi-version"
...
kube::codegen::gen_openapi \
    --output-dir "${SCRIPT_ROOT}/pkg/api/openapi" \
    --output-pkg "k8s.io/${THIS_PKG}/pkg/api/openapi" \
